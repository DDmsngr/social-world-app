    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(_formatWhen(event.startsAt), style: AppTypography.serif(15, color: AppColors.primaryTint)),
          ...
          Row(
            children: [
              Icon(Icons.person_outline, size: 16, color: AppColors.textFaint),
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    backgroundColor:
                        event.joinedByMe ? AppColors.primary : Colors.transparent,
                  ),
